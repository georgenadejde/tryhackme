...
![The encryption function takes the plaintext and the key as input and returns the ciphertext as output.](5f04259cf9bf5b57aed2c476-1725293744539.svg)  
...
![The decryption function takes the ciphertext and the key as input and returns the plaintext as output.](5f04259cf9bf5b57aed2c476-1725293763258.svg)
...
We can easily figure out that T becomes W, R becomes U, Y becomes B, and so on. As you noticed, once we reach Z, we start all over
...
You can experiment with Caesar cipher shifts using the interactive tool at the [Cryptii website](https://cryptii.com/pipes/caesar-cipher). It lets you tweak the rotation and instantly see how the text transforms.
### Questions

Q: Knowing that `XRPCTCRGNEI` was encrypted using Caesar Cipher, what is the original plaintext?

![](2025-12-17_11-22.png)
